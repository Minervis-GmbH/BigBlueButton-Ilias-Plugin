...
class ilObjBigBlueButtonGUI extends ilObjectPluginGUI
{
    ...
    public function showContent()
    {
        ...
        $client_js = new ilTemplate("./public/Customizing/global/plugins/Services/Repository/RepositoryObject/BigBlueButton/templates/client.js", true, true);

        if ($isModerator) {
            $my_tpl = new ilTemplate("./public/Customizing/global/plugins/Services/Repository/RepositoryObject/BigBlueButton/templates/tpl.BigBlueButtonModeratorClient.html", true, true);
            ...
            $my_tpl = new ilTemplate("./public/Customizing/global/plugins/Services/Repository/RepositoryObject/BigBlueButton/templates/tpl.BigBlueButtonClient.html", true, true);
    ...
    public function endClass()
    {
        ...
        $my_tpl = new ilTemplate("./public/Customizing/global/plugins/Services/Repository/RepositoryObject/BigBlueButton/templates/tpl.BigBlueButtonModeratorMeetingEnded.html", true, true);
    ...
    public function startClass()
    {
        ...
        $my_tpl = new ilTemplate("./public/Customizing/global/plugins/Services/Repository/RepositoryObject/BigBlueButton/templates/tpl.BigBlueButtonModeratorMeetingCreated.html", true, true);
